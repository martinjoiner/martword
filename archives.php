...
<?php the_content(__('Continue reading','martword'));?>
<?php
// echo archives start
...
if(empty($output)){
	...
	if ($monthresults) {
		...
		$output = '<strong>'. __('Not Found','martword') .'</strong> '. __("Sorry, but you are looking for something that isn't here.",'martword') .'';
	}
